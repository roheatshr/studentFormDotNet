...
namespace CourseWork
{
    public static class Utility
    {
        ...
        internal static void WriteToTextFile(object filePath, string data, bool v)
        {
        ...
        internal static void WriteToTextFile(object filePath, string data, bool v, int count)
        {
            throw new NotImplementedException();
        }
    }
